...
import com.example.nhasach.adapter.LvThemHoaDonAdapter;
import com.example.nhasach.adapter.SpThemHoaDonAdapter;
...
public class ThemHoaDonActivity extends AppCompatActivity {
    ...
    Button btnThemVaoGioHang, btnThanhToan;
...
//       get day month year
    ...
    private void init() {
        ...
        btnThanhToan = findViewById(R.id.btnXemHoaDon);
    }
